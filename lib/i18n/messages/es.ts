export const esMessages = {
  ...
  landing: {
    ...
    apps: {
      ...
      cards: {
        ...
        tasks: {
          desc: "Separá el trabajo en espacios (personal, laburo u otros) y seguí tareas en un Kanban simple con vencimientos y comentarios.",
          features: [
            "Espacios para distintos contextos",
            "Vistas Kanban y lista",
            "Vencimientos y comentarios",
            "Archivá lo terminado",
          ],
        },
      },
      cta: "Comenzar",
  ...
  links: {
    ...
    fields: {
      ...
      reviewDueDateHint: "Definí cuándo querés volver a revisar este link.",
      reviewed: "Revisado",
  ...
  tasks: {
    ...
    dashboardEmptyBody:
      "Creá un espacio para organizar tus tareas. El primero puede llamarse Personal o como prefieras.",
    dashboardEmptyCta: "Crear primer espacio",
    manageSpacesTitle: "Gestionar espacios",
    manageSpacesEmpty: "No hay espacios. Agregá uno abajo.",
    ...
    deleteSpaceMoveTargetPlaceholder: "Elegí un espacio",
    deleteSpaceNoOtherSpace:
      "No tenés otro espacio. Solo podés eliminar todas las tareas junto con este espacio.",
    ...
    emptySpaceBody: "Creá una tarea o cambiá de espacio.",
    emptySearchTitle: "No hay tareas que coincidan",
    emptySearchBody: "Probá otras palabras o limpiá la búsqueda.",
    ...
    fields: {
      ...
      descriptionPlaceholder: "Agregá contexto…",
      dueDate: "Vencimiento (opcional)",
      dueDateNaturalPlaceholder: "Mañana o el viernes que viene",
      dueDateHint: "Escribí una fecha o presioná ↓ para abrir el calendario.",
      comments: "Comentarios",
      commentPlaceholder: "Escribí una actualización…",
