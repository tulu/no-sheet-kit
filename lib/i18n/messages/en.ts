...
export const enMessages = {
  ...
  apps: {
    ...
    settings: {
      ...
      storage: {
        title: "Storage usage",
        description: "Each app uses browser storage with an estimated maximum of {max} per app.",
        totalUsed: "Total used in this browser: {used}",
        usedOfMax: "{used} of {max}",
        progressAria: "{app} storage usage: {percent}",
      },
      dataManagement: {
